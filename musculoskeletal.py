...
def get_muscle_force_length_regression():
    ...
    muscle_length = data_force_length[:,0];
    force_length = data_force_length[:,1]

    data_force_length[:, 1] = (muscle_length/muscle_length.max())
    data_force_length[:, 0] = (force_length/force_length.max())*1.3
